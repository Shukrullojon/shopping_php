                    ...
                    <div class="panel panel-primary">
                        <form action="action.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="panel-footer">
                                <input type="submit" class="form-control btn btn-success" value="create product" name="create_product">
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        while ($row=mysqli_fetch_array($query)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="../image/product/<?php echo $row['image'] ?>"  class="img-responsive img-rounded" style="width:80px;height:50px;">
                                </td>
                                <td>
                                    <?php
                                        if($row['status']){
